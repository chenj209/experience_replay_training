...
class DatasetDiskPmid(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #for idx, file_name in enumerate(file_names):
            ...
            ps_lvl = get_ps_from_x(tx_raw, self.hyam, self.hybm)
            tx_raw = np.concatenate((tx_raw[:,:121], ps_lvl), axis=1)
            tx = normalize_x_pmid(tx_raw)
