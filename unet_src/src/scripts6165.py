...
#                   network = 'cnn2_pad'
#                   name = 'unet_tkdedata_wx_alldata_rmBadData_0-29_{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}_wxnorm'.format(
#                       network, activation, batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
#                   print(name)
#                   commands = 'CUDA_VISIBLE_DEVICES=0 python run_de.py --data_dir /home/users/data/tkde_set/tkde_set/ --output_type 0-29 --noise_std {} ' \
...
#                   os.system(commands)
                   ...
                   #    network, activation, batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                   #print(name)
                   #commands = 'CUDA_VISIBLE_DEVICES=1 python run_de.py --data_dir /home/users/data/tkde_set/tkde_set/ --output_type 30-59 --noise_std {} ' \
                   #           '--test_dir /home/users/data/tkde_set/tkde_testset/ ' \
                   #           '--network {} --activation {} --dropout {} ' \
                   #           '--train-batch {} --lr_strategy {} --lr {} --epoch {} --wd {} --workers 8 ' \
                   #           '--checkpoint ckpts/{}'.format(str(noise_std),
...
#                     os.system(commands)
                    ...
                    name = 'unet_tkdedata_alldata_rmBadData_61-65_{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}_wxnorm'.format(
                        network, activation, batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                    print(name)
                    commands = 'CUDA_VISIBLE_DEVICES=3 python run_de.py --data_dir /home/users/data/tkde_set/tkde_set/ --output_type 61-65 --noise_std {} ' \
                               '--test_dir /home/users/data/tkde_set/tkde_testset/ ' \
                               '--network {} --activation {} --dropout {} ' \
                               '--train-batch {} --lr_strategy {} --lr {} --epoch {} --wd {} --workers 8 ' \
                               '--checkpoint ckpts/{}'.format(str(noise_std),
