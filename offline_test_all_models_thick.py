...
from dataloader_time_embedded import TimeDatasetDisk, get_inverse
#from dataloader_qsat_water import get_inverse, DatasetDisk
...
HYBI = np.load("hybi.npy")
HYAI = np.load("hyai.npy")
LATVAP = 2.5104e6
