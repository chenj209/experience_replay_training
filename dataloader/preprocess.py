...
class MinMaxTransformLegacy2stepNoFSDS:
    ...
    def __call__(self, sample):
        ...
        data_x[186:186+30] = (data_x[186:186+30] - 0) / (0.0238) * 2 -1  # Q
        data_x[186+30:186+60] = (data_x[186+30:186+60] - 159) / (323 - 159) * 2 - 1 # T
        data_x[186+60:186+90] = (data_x[186+60:186+90] + 2.13e-6) / (2.13e-6*2) * 2 - 1 # dqls
        data_x[186+90:186+120] = (data_x[186+90:186+120] + 3.89e-3) / (3.89e-3*2) * 2 - 1 # dTls
        data_x[186+120]    = (data_x[186+120] - 0)     / (1412 - 0) # solin
        data_x[186+121]    = (data_x[186+121] - 59928) / (105782 - 59928) # ps
