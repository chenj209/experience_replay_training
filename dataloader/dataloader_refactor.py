...
if __name__ == '__main__':
    ...
    if not os.path.isdir(data_dir):
        # data_dir = "./data/"
        data_dir = "/Users/jiandachen/Projects/NNCAM_packages/precip_pattern/data/"
    ...
    training_set = DatasetDisk(file_names, is_train=True, noise_std=0, filename=True,output_normalized=False)
    ...
    for idx, batch in enumerate(trainloader):
        ...
        #np.save('checkcode_x_old'+str(idx), x.numpy())
        np.save('checkcode_x_old'+str(idx), x_raw.numpy())
        np.save('checkcode_y_old'+str(idx), y.numpy())
#         if idx == 1:
#             break
