...
def test_single_column_multistep0():
    ...
    print_mean_std_by_var(norm_data_x, col_names_x, COL_NAMES_X)
    print_mean_std_by_var(norm_data_y, col_names_y, COL_NAMES_Y)
    print("Raw Mean Std by var")

    print_mean_std_by_var(raw_data_x, col_names_x, COL_NAMES_Y)
    print_mean_std_by_var(raw_data_y, col_names_y, COL_NAMES_Y)
