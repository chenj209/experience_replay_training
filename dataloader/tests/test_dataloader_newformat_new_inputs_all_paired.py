...
def test_single_column_multistep0():
    ...
    norm_data_y = np.concatenate(norm_data_y_resmlp, axis=0)
    print("norm_data_x_ae shape: ", norm_data_x_ae.shape)
    print("norm_data_x_resmlp shape: ", norm_data_x_resmlp.shape)
    print("norm ae:")
    print_mean_std_by_var(norm_data_x_ae, col_names_x, col_names)
    print_mean_std_by_var(norm_data_x_ae, col_names_x, col_names, delevelwise=True, reduce_lvl=6)
    print("norm resmlp:")
    print_mean_std_by_var(norm_data_x_resmlp, col_names_x, col_names)
