        ...
        for lr in ['0.0001']:
            for batch_size in ['32']:
                for noise_std in ['0']:
                    ...
                    print(name)
                    commands = 'CUDA_VISIBLE_DEVICES={} python train_nn_region_stdtest.py --region_mask all --land_align 0 --data_dir /data/nncam_data/image_set/ --output_type 0-29 --noise_std {} ' \
