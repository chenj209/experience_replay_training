    ...
    for num_blocks in ['7']:
        for node_size in ['512']:
            for lr in ['0.001']:
                ...
                network = 'mlp_output30'
                name = 'rmbaddata_wxnorm_subset_mlp_0-29_{}_nodesize{}_num_blocks{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}'.format(
                    network, node_size, num_blocks, activation,
                    batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                print(name)
                commands = 'CUDA_VISIBLE_DEVICES=0 screen python run_de_subset_files.py --data_dir /data/training_data/image_set --output_type 0-29 --noise_std {} ' \
                           '--network {} --node_size {} --num_blocks {} --activation {} --dropout {} ' \
                           '--train-batch {} --lr_strategy {} --lr {} --epoch {} --wd {} ' \
                           '--checkpoint ckpts_mlp/{}'.format(str(noise_std),
                                                          network, node_size, num_blocks, activation,
                                                          dropout,
                ...
                name = 'rmbaddata_wxnorm_subset_30-59_{}_nodesize{}_num_blocks{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}'.format(
                    ...
                    batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                print(name)
                commands = 'CUDA_VISIBLE_DEVICES=1 screen python run_de_subset_files.py --data_dir /data/training_data/image_set --output_type 30-59 --noise_std {} ' \
                           '--network {} --node_size {} --num_blocks {} --activation {} --dropout {} ' \
                           '--train-batch {} --lr_strategy {} --lr {} --epoch {} --wd {} ' \
                           '--checkpoint ckpts_mlp/{}'.format(str(noise_std),
                                                          network, node_size, num_blocks, activation,
                ...
                name = 'rmbaddata_wxnorm_subset_nopenalty_61-65_{}_nodesize{}_num_blocks{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}'.format(
                    ...
                    batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                print(name)
                commands = 'CUDA_VISIBLE_DEVICES=3 screen python run_de_subset_files.py --data_dir /data/training_data/image_set --output_type 61-65 --noise_std {} ' \
                           '--network {} --node_size {} --num_blocks {} --activation {} --dropout {} ' \
                           '--train-batch {} --lr_strategy {} --lr {} --epoch {} --wd {} ' \
                           '--checkpoint ckpts_mlp/{}'.format(str(noise_std),
                                                          network, node_size, num_blocks, activation,
