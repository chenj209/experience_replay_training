...
from dataloader_landseastd import DatasetDiskLandSeaStd
...
def main(args):
    ...
    Define dataloader
    """
    training_set = DatasetDiskLandSeaStd(train_files, is_train=True, noise_std=args.noise_std, land_align=args.land_align)
    trainloader = data.DataLoader(training_set, shuffle=True, batch_size=args.train_batch, num_workers=args.workers)

    validation_set = DatasetDiskLandSeaStd(test_files, is_train=False, noise_std=args.noise_std, land_align=args.land_align)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--land_align', type=int, help='whether to align sea to land or the inverse')
