...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_model3059_sampled12_multistep1_new_vars_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_model6165_sampled12_multistep1_new_vars_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_model029_sampled12_multistep1_new_vars_CCS_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
