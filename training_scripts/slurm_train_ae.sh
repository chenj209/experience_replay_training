...
srun --constraint=gpu --ntasks 1 -G 4 python scripts_train_ae_model_ex.py --ae_config $1 --region_mask ../consts/pacific_region_mask.npy --rec_weight 0.4 --pred_weight 0.6 --ex_input_prev $2 --ex_input $3
