...
if __name__ == "__main__":
    ...
    name = f"combined_ae_model029_sampled1_0401_multistep{args.multistep}_weight{args.pred_weight}_{args.rec_weight}_{args.ae_config.rstrip('.json')}_EX_{'+'.join(ex_input)}_EXPREV_{'+'.join(ex_input_prev)}"
