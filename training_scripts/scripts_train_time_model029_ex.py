...
if __name__ == "__main__":
    ...
    name = f"time_model029_sampled12_0225_multistep{args.multistep}_EX_{'+'.join(ex_input)}_EXPREV_{'+'.join(ex_input_prev)}_region_{args.region_mask.split('/')[-1].rstrip('.npy')}"
