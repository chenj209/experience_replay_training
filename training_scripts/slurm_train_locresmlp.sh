...
srun --constraint=gpu --ntasks 1 -G 1 python scripts_train_locresmlp.py --ae_config $1 --region_mask ../consts/pacific_region_mask.npy --rec_weight 1.0 --pred_weight 0.0 --ex_input_prev $2 --ex_input $3
