...
#: <<'sampled12_qtend_legacy_training_with_new_vars_CAPE_SPPRECC'
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_model029_sampled12_multistep1_new_vars_CS_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
    --input_vars QL T_nn_in dqvls_nn_in dTls_nn_in SOLIN SPPS UL VL LWUP CAPE \
    --output_vars qtend_check \
    --input_vars_prev FLNS FLNT SPPRECC qtend_check stend_check SOLL SOLS SOLSD SOLLD FSDS \
    --lr_strategy coslr \
    --network resnet_output30 \
    --train_batch 32 \
    --worker 4
...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_model3059_sampled12_multistep1_new_vars_CS_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_model6165_sampled12_multistep1_new_vars_CS_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_modelCAPE_sampled12_multistep1_new_vars_CS_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
...
python train_time_model_legacy_format.py  \
    --data_dir /data/nncam_data/image_set/ \
    --ex_data_dir /data/chenj209/ex_dataset/ \
    --checkpoint /share3/chenj209/ckpts_sampled12/conv_mem/baseline_modelSPPRECC_sampled12_multistep1_new_vars_CS_region_all/ \
    --data_means ../consts/all_means.npz \
    --data_stds ../consts/all_stds.npz \
    --multistep 1 \
    --sample_rate 12 \
