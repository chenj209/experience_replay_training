...
def main(args):
    ...
    test_files = glob.glob('/cust_users/alg/TKDE.lab/TKDE_dataset/testset'+'/*')#all_files[::10]
    train_files = glob.glob('/cust_users/alg/TKDE.lab/TKDE_dataset/trainset'+'/*')#[file_name for file_name in all_files if file_name not in test_files]
