...
srun --constraint=gpu --ntasks 1 -G 4 python scripts_train_ae_combined.py --ae_config $1 --region_mask ../consts/twp_region.npy --data_means ../consts/twp_region_means.npz --data_stds ../consts/twp_region_stds.npz --rec_weight 0.4 --pred_weight 0.6 --resume $2
