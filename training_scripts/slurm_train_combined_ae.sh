...
srun --constraint=gpu --ntasks 1 -G 4 python scripts_train_ae_combined.py --ae_config $1 --region_mask ../consts/twp_region.npy --rec_weight 0.4 --pred_weight 0.6 --resume $2
