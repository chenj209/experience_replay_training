        ...
        for lr in ['0.0001']:
            for batch_size in ['32']:
                for noise_std in ['0']:
                    ...
                    name = 'modelrhcap2_0-29_{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}_wxnorm'.format(
                        network, activation, batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                    print(name)
                    commands = 'CUDA_VISIBLE_DEVICES={} python train_rh_cap_model.py --data_dir /home/users/data/nncam_data/image_set/ --output_type 0-29 --noise_std {} ' \
