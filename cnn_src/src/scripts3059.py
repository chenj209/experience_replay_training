...
#                     os.system(commands)
                    ...
                    network = 'cnn2_pad'
                    name = 'test_wx_alldata_rmBadData_30-59_{}_act{}_bs{}_scheduler_{}_lr{}_ep{}_noise{}_wd{}_dropout{}_wxnorm'.format(
                        network, activation, batch_size, lr_strategy, lr, epoch, noise_std, weight_decay, dropout)
                    print(name)
                    commands = 'CUDA_VISIBLE_DEVICES=2 python run_de.py --data_dir /home/users/data/tkde_set/tkde_set/ ' \
                               '--test_dir /home/users/data/tkde_set/tkde_testset/ ' \
                               '--output_type 30-59 --noise_std {} ' \
                               '--network {} --activation {} --dropout {} ' \
                               '--train-batch {} --lr_strategy {} --lr {} --epoch {} --wd {} --workers 8 ' \
